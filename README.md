...
| 🪟 **Peta е свободна навсякъде по телефона** | Пусни „Плаващ прозорец" и Peta пада заради гравитация, отскача от четирите ръба на екрана **над всяко друго приложение** — не е залепена за края, разхожда се свободно. Влачиш я с пръст и я хвърляш с инерция; тап отваря приложението, задържане на място я скрива. Автоматично се крие, докато си вътре в Emotion Pet — там вече виждаш Peta директно. |
...
├── PetOverlayActivity.kt # базов клас — закача MiniPetOverlay + управлява системния overlay
├── MiniPetOverlay.kt    # малкият физически Peta върху всеки екран освен стаята
├── FloatingPetView.kt   # физическият Peta за системния overlay (над други приложения)
...
- [x] Peta се разхожда свободно **над други приложения** с истинска гравитация (`FloatingPetView`), не само peek от края
