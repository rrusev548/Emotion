...
| 👉 **Quick actions при tap** | Докосни Peta и се появява ред с преки пътища (Чат/Задачи/Агенти/Памет) — прибира се сам или при tap встрани. |
...
| 🪟 **Edge Pop overlay** | Peta наднича полу-скрит от края на екрана над другите приложения — влачиш го, при пускане сам се "прибира" (snap) към най-близкия край; тап отваря приложението, задържане на място го скрива. |
...
- [x] Quick actions при tap върху Peta
